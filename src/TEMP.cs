...
namespace Lasers
{
    class Program : Window
    {
            ...
            : base(width, height, title)
        {
            ...
            _lineArray = new DrawingLines();
            // Vertices
            _lineArray.AddBuffer(_lineBuffer, 0, 0, DataType.Double, AttributeSize.D2);
            // Colour
            _lineArray.AddBuffer(_lineBuffer, (uint)ShaderLocation.Colour, sizeof(Vector2), sizeof(LinePoint), DataType.Float, AttributeSize.D4);
        ...
        private readonly DrawingLines _lineArray;
        ...
        protected override void OnUpdate(FrameEventArgs e)
        {
            ...
            DrawManager.View = Matrix4.CreateTranslation((Vector3)offset) * Matrix4.CreateScale(_zoom);
            
            _shader.ColourSource = ColourSource.AttributeColour;
            e.Context.Draw(_lineArray);
            
            //_textRenderer.Model = Matrix4.CreateScale(10) * Matrix4.CreateTranslation(0, (Height * 0.5) - 10);
            //_textRenderer.DrawLeftBound(e.Context, $"Bounces: {_bounceCount}", _font, 0, 0);
        }
        
        private Vector2 MousePos
        {
            get => ((2d / (Vector2)Size) * MouseLocation) - 1d;
        }
        ...
        protected override void OnSizeChange(VectorIEventArgs e)
        {
            ...
            _textRenderer.Projection = Matrix4.CreateOrthographic(e.X, e.Y, 0, -1);
        }
